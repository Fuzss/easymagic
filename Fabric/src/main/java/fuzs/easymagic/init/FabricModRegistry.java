...
public class FabricModRegistry {
    ...
    public static final RegistryReference<BlockEntityType<ModEnchantmentTableBlockEntity>> ENCHANTING_TABLE_BLOCK_ENTITY_TYPE = REGISTRY.registerBlockEntityTypeBuilder("enchanting_table", () -> ModBlockEntityTypeBuilder.of(ModEnchantmentTableBlockEntity::new, Blocks.ENCHANTING_TABLE));
