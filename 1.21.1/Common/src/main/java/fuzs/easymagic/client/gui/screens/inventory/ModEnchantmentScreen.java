...
public class ModEnchantmentScreen extends EnchantmentScreen {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        guiGraphics.blit(ENCHANTING_TABLE_LOCATION,
                this.leftPos,
                this.topPos,
                0.0F,
                0.0F,
        ...
        for (int i = 0; i < 3; ++i) {
            guiGraphics.blitSprite(ENCHANTMENT_SLOT_DISABLED_SPRITE,
                    this.leftPos + 60,
                    this.topPos + 14 + 19 * i,
                    108,
                    19);
        ...
        if (!EasyMagic.CONFIG.get(ClientConfig.class).keepEnchantmentScreenBook()) {
            guiGraphics.blit(RerollButton.ENCHANTING_TABLE_REROLL_LOCATION,
        ...
        if (EasyMagic.CONFIG.get(ServerConfig.class).dedicatedRerollCatalyst()) {
            guiGraphics.blit(ENCHANTING_TABLE_LOCATION, this.leftPos + 4, this.topPos + 46, 14, 46, 18, 18, 256, 256);
            guiGraphics.blit(ENCHANTING_TABLE_LOCATION, this.leftPos + 22, this.topPos + 46, 34, 46, 18, 18, 256, 256);
