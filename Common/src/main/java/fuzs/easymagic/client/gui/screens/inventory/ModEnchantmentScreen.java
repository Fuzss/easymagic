...
public class ModEnchantmentScreen extends EnchantmentScreen {
    private static final Component RE_ROLL_ENCHANTMENTS_TOOLTIP = Component.translatable("container.enchant.reRoll").withStyle(ChatFormatting.GRAY);
    ...
    private void addLapisComponent(int amount, List<Component> tooltip) {
        ...
        if (amount == 1) {
            component = Component.translatable("container.enchant.lapis.one");
        } else {
            component = Component.translatable("container.enchant.lapis.many", amount);
        }
    ...
    private void addLevelComponent(int amount, List<Component> tooltip) {
        ...
        if (amount == 1) {
            ...
            component = Component.translatable("container.enchant.level.many", amount);
        }
